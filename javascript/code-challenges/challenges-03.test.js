...
const typeNum = (arr) => {
  // Solution code here...
  let resultArr = arr.filter(element => !isNaN(element)
    // if (!isNaN(element)) {
    //   return true;
    // }
  );
...
const containsAnd = (arr) => {
  // Solution code here...
  let resultArr = arr.filter(element => element.includes('and')
...
const oddValues = (arr) => {
  // Solution code here...
  let resultArr = arr.filter(element => element % 2 === 1
    // if (element % 2 === 1) {
    //   return true;
    // }
  );
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let resultArr = arr.filter(element => element.baseStat > minBaseStat
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let baseArray = getBaseStatGreaterThan(arr, minBaseStat);
  let resultArr = baseArray.map(element => element.stat.name);
  return resultArr;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let baseArray = arr.filter(element => typeof element === 'number');
  console.log(baseArray);
  let resultArr = baseArray.map(element => {
    if (element % 2 === 0) {
      return 'even';
    }else{
      return 'odd';
