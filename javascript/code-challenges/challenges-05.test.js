...
const toLastNames = people => {
  // Solution code here...
  let arrayOfNames = people.map(element => {
...
const addValues = (arr) => {
  // Solution code here...
  let sumResult = arr.reduce((acc, element) => {
    acc = acc + element;
    return acc;
  }, 0);
  return sumResult;
...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPurchase = arr.reduce((acc, element) => {
    acc = acc + element.purchasePrice;
    return acc;
  }, 0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let arrayLength = arr.reduce((acc) => {
    acc = acc + 1;
    return acc;
  }, 0);
  return arrayLength;
...
const reversedString = (str) => {
  ...
  let reverse = strArray.reduce((acc, element) => {
    console.log(element);
    acc = element + acc;
    console.log(acc);
    return acc;
...
const countNumberOfChildren = (arr) => {
  ...
  let resultArr = arr.reduce((acc, element) =>
    element.children ? acc = acc + element.children.length : acc, 0);
  return resultArr;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let result = arr.reduce((acc, element) => isPrime(element) ? acc = acc + 1 : acc, 0);
  return result;
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  let resultObject = arr.reduce((acc, element) => {
    // acc = null;
    statName === element.stat.name ? acc = element : acc;
    //  {
    //   console.log(element);
