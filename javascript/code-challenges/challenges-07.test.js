...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let resultArr = starWarsArr.sort((a, b) => b.height - a.height);
  return resultArr;
};
...
const joinArray = (arr) => {
  // Solution code here...
  // let resultArr = arr.reduce((acc,element)=> acc = acc + " " + element,'');
...
const listFoods = (recipe) => {
  ...
  for (let i = 0; i < recipe.ingredients.length; i++) {
    splitArr = recipe.ingredients[i].split(" ");
    // console.log(splitArr);
    qwe = splitArr.slice(2);
    // console.log(qwe);
    result.push(qwe.join(' '));
    // console.log(result);
  }
  return result;
};
...
const stepActions = (recipe) => {
  ...
  for (let i = 0; i < recipe.steps.length; i++) {
    splitArr = recipe.steps[i].split(" ");
    // console.log(splitArr);
    qwe = splitArr.slice(0, 1);
    // console.log(qwe);
    result.push(qwe.join(' '));
    // console.log(result);
  }
...
const totalSumCSV = (str) => {
  ...
  // Solution code here...
  let strArr = str.split(",");
  total = strArr.reduce((acc, element) => acc = acc + Number(element), 0);
  return total;
};
...
const removeVowels = (str) => {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    if ((result.charAt(i)) === "o" || result.charAt(i) === "e" || result.charAt(i) === "i" || result.charAt(i) === "a" || result.charAt(i) === "u") {
      // console.log(str.charAt(i));
      // console.log(str);
      // console.log(str.replace(str.charAt(i),""));
...
const extractVowels = (str) => {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    if ((result.charAt(i)) === "o" || result.charAt(i) === "e" || result.charAt(i) === "i" || result.charAt(i) === "a" || result.charAt(i) === "u") {
      ...
      // console.log(str);
      // console.log(str.replace(str.charAt(i),""));
      vowelStr = vowelStr + result.charAt(i);
      result = result.replace(result.charAt(i),"");
      console.log(result);
      i--;
    }
  }
  resultArr.push(result,vowelStr);
